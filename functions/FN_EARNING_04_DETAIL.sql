drop function Commissions.fn_Earning_04_Detail;
CREATE function Commissions.fn_Earning_04_Detail
/*-------------------------------------------------------
* @author		Larry Cardon
* @category		Function
* @date			2-Jun-2017
*
* @describe		Returns a resultset of Perferred Translations Detail
*
...
*					decimal		bonus_sub
*
* @example		select * from fn_Earning_04_Detail(1001, 10);
-------------------------------------------------------*/
