...
class DNSTypes
{
	...
	function DNSTypes()
	{
		...
		$this->AddType(52,"TLSA"); // RFC 6698 (TLSA certificate association)
		$this->AddType(55,"HIP"); // RFC 5205 (Host Identity Protocol)
		$this->AddType(59,"CDS"); // RFC 7344 (Child DS)
		$this->AddType(60,"CDNSKEY"); // RFC 7344 (Child DNSKEY)
		...
		$this->AddType(257,"CAA"); // RFC 6844 (Certification Authority Authorization)
