...
$config = [
    ...
    'admin' => [
		...
		// IMPORTANT WaSQL CONFIGURATION NOTE: For WaSQL, use User Authentication settings in WaSQL Configuration GUI. Alternatively, consider using autoconfiguration instrad of manual configuration. See the autoconfigure notes and code at the end of this file.
...
// If WaSQL is serving this page, use WaSQL's SimpleSAMLphp autoconfig script, else use the standard autoconfig script in additional to manual configuration above.
