...
require_once "{$progpath}/Templates.php";
require_once "{$progpath}/Exports.php";
require_once "{$progpath}/Users.php";
require_once "{$progpath}/Rejects.php";
require_once "{$progpath}/Inbound.php";
require_once "{$progpath}/Tags.php";
require_once "{$progpath}/Messages.php";
require_once "{$progpath}/Whitelists.php";
require_once "{$progpath}/Ips.php";
require_once "{$progpath}/Internal.php";
require_once "{$progpath}/Subaccounts.php";
require_once "{$progpath}/Urls.php";
require_once "{$progpath}/Webhooks.php";
require_once "{$progpath}/Senders.php";
require_once "{$progpath}/Metadata.php";
require_once "{$progpath}/Exceptions.php";
...
class Mandrill {
    ...
    public function __construct($apikey=null) {
        ...
        $this->ch = curl_init();
        //turn off local cert verification
