...
this.stop();if(undefined!=this.frm){sumulateEvent(this.frm,'submit')}};recognition.onerror=function(e){if(undefined!=this.ico){this.ico.classList.remove('w_blink');this.ico.classList.remove('w_success');this.ico.classList.add('w_danger')}
this.stop()}}
return!1}
