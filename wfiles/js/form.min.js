...
recognition.inp=inp;recognition.start();recognition.debug=debug;recognition.onresult=function(e){if(undefined!=this.frm&&undefined!=window[this.frm]){try{window[this.frm](e.results[0][0].transcript);this.stop();this.start()}catch(e){}}
