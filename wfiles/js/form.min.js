...
function formDictate(inp,ico){inp=getObject(inp);if(undefined==inp){console.log('formDictate error: undefined input '+inp);return!1}
ico=getObject(ico);if(window.hasOwnProperty('webkitSpeechRecognition')){let recognition=new webkitSpeechRecognition();recognition.continuous=!1;recognition.interimResults=!1;recognition.lang="en-US";if(undefined!=ico){ico.classList.add('w_blink');ico.classList.add('w_success');recognition.ico=ico}
...
this.stop();simulateEvent(this.inp,'enter')};recognition.onerror=function(e){if(undefined!=this.ico){this.ico.classList.remove('w_blink');this.ico.classList.remove('w_success');this.ico.classList.add('w_danger')}
this.stop()}}
return!1}
