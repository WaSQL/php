...
let sets=filters.split(";");for(let s=0;s<sets.length;s++){let fltrs=sets[s].split(" ",3);let id='id'+fltrs[0]+fltrs[1];if(undefined!=fltrs[2]){id=id+fltrs[2].replace(/[\W_]+/g,"")}
let obj=frm.querySelector('#'+id);let filters=new Array();if(undefined!=obj){obj.style.display='inline-block'}else{let d=document.createElement('div');d.className='w_pagingfilter';d.setAttribute('data-field',fltrs[0]);d.setAttribute('data-operator',fltrs[1]);d.setAttribute('data-value',fltrs[2]);d.id=id;let dfield=fltrs[0];if(dfield=='*'){dfield='Any Field'}
let doper=fltrs[1];let dval='\''+fltrs[2]+'\'';switch(doper){case 'ct':doper='Contains';break;case 'nct':doper='Not Contains';break;case 'ca':doper='Contains Any of These';break;case 'nca':doper='Not Contain Any of These';break;case 'eq':doper='Equals';break;case 'neq':doper='Not Equals';break;case 'ea':doper='Equals Any of These';break;case 'nea':doper='Not Equals Any of These';break;case 'gt':doper='Greater Than';break;case 'lt':doper='Less Than';break;case 'egt':doper='Equals or Greater than';break;case 'elt':doper='Less than or Equals';break;case 'ib':doper='Is Blank';dval='';break;case 'nb':doper='Is Not Blank';dval='';break}
