...
recognition.onerror=function(e){if(this.continuous){if(undefined!=e.error&&e.error=='no-speech'){try{this.restart()}catch(e){}}else{console.log(e);if(this.debug){alert('ERROR: '+e.stack)}}}else{try{this.stop()}catch(e){if(this.debug){alert('ERROR: '+e.stack)}}
