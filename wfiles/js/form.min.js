...
if(cval.toLowerCase()=='yes'){display=1}
break}}
if(display==1){if(undefined!=els[i].dataset.display){els[i].style.display=els[i].dataset.display}else{els[i].style.display='block'}}else{els[i].style.display='none'}}else{els[i].display='none'}}}
