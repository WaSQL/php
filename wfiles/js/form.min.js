...
d.innerHTML='<span class="icon-filter w_grey"></span> '+dfield+' '+doper+' '+dval+' <span class="icon-cancel w_danger w_pointer" onclick="removeId(\''+id+'\');"></span>';let p=getObject('send_to_filters');p.appendChild(d)}
...
let d=document.createElement('div');d.className='w_pagingfilter icon-erase w_big w_danger';d.id='paging_clear_filters';d.setAttribute('title','Clear All Filters');d.onclick=function(){pagingClearFilters(getParent(this,'form'))};let p=getObject('send_to_filters');p.appendChild(d)}
