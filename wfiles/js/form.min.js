...
for(let x=0;x<daynames.length;x++){let hval=parseInt(daynames[x].value);if(undefined!=v.dayname&&undefined!=v.dayname[0]&&v.dayname[0]==-1){daynames[x].checked=!0;nv.dayname=[-1]}else if(in_array(hval,v.dayname)){daynames[x].checked=!0;nv.dayname.push(hval)}else{daynames[x].checked=!1}}
