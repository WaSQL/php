...
if(undefined!=theForm.show_upload_progress){html='';html+='<div class="w_centerpop_title">Uploading...</div>'+"\n";html+='<div class="w_centerpop_content">'+"\n";html+='	<div class="w_padtop"><span class="icon-spin4 w_rotate w_spin"></span> Uploading ...</div>'+"\n";html+='</div>'+"\n";centerpopDiv(html,0)}
return!0}
function formShowUploadProgress(name){ajaxGet('/php/index.php','centerpop99',{get_upload_progress_json:1,name:name})}
