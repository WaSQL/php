...
var label=document.querySelector('label[for='+fld.id+']');if(fileName){setText(label,'<span class="icon-upload w_big w_success"></span> '+fileName);label.className='btn btn-default'}else{setText(label,'<span class="icon-upload w_big w_danger"></span> '+fld.getAttribute('data-text'));label.className='btn btn-default'}}
...
function pagingSetOffset(frm,v){frm.filter_offset.value=v;pagingSetFilters(frm);frm.submit()}
function pagingSetOrder(frm,v){if(frm.filter_order.value==v&&frm.filter_order.value.indexOf('desc')==-1){v=v+' desc'}
frm.filter_order.value=v;pagingSetFilters(frm);frm.submit()}
...
var v=frm.filter_field.value;frm.filter_field.value='';pagingSetFilters(frm);frm.filter_field.value=v;frm.filter_bulkedit.value='1';frm.submit()}
function pagingExport(frm){pagingSetFilters(frm);frm.filter_export.value='1';frm.submit()}
