...
return!1}
ico=getObject(ico);if(window.hasOwnProperty('webkitSpeechRecognition')){var speechEngine=SpeechRecognition||webkitSpeechRecognition;var recognition=new speechEngine();recognition.continuous=continuous||!1;recognition.interimResults=!1;recognition.lang="en-US";if(undefined!=ico){ico.classList.add('w_blink');ico.classList.add('w_success');recognition.ico=ico}
