...
let minutes=container.querySelectorAll('input.frequency_minute');let hours=container.querySelectorAll('input.frequency_hour');let months=container.querySelectorAll('input.frequency_month');let days=container.querySelectorAll('input.frequency_day');let daynames=container.querySelectorAll('input.frequency_dayname');let field=container.querySelector('#'+fid);let nv={minute:[],hour:[],month:[],day:[],dayname:[]};if(undefined!=v){if(typeof(v)=='number'){switch(v){case 1:v={minute:[-1],hour:[-1],month:[-1],day:[-1],daynames:[-1]};break;case 5:v={minute:[0,5,10,15,20,25,30,35,40,45,50,55],hour:[-1],month:[-1],day:[-1],daynames:[-1]};break;case 10:v={minute:[0,10,20,30,40,50],hour:[-1],month:[-1],day:[-1],daynames:[-1]};break;case 15:v={minute:[0,15,30,45],hour:[-1],month:[-1],day:[-1],daynames:[-1]};break;case 20:v={minute:[0,20,40],hour:[-1],month:[-1],day:[-1],daynames:[-1]};break;case 30:v={minute:[0,30],hour:[-1],month:[-1],day:[-1],daynames:[-1]};break;case 60:v={minute:[0],hour:[-1],month:[-1],day:[-1],daynames:[-1]};break;case 1440:v={minute:[0],hour:[0],month:[-1],day:[-1],daynames:[-1]};break;case 720:v={minute:[0],hour:[0,12],month:[-1],day:[-1],daynames:[-1]};break;case 10080:v={minute:[0],hour:[0],month:[-1],day:[1,8,15,22],daynames:[-1]};break;case 43829:v={minute:[0],hour:[0],month:[-1],day:[1],daynames:[-1]};break}}
if(typeof(v)=='string'){if(v.length>0){v=JSON.parse(v)}else{v={minute:[],hour:[],month:[],day:[],daynames:[]}}}
