...
function formDictate(inp,ico,frm,continuous,debug){inp=getObject(inp);if(undefined==debug){debug=!1}
if(undefined==inp){let err='formDictate error: undefined input '+inp;if(debug){alert(err)}else{console.log(err)}
return!1}
...
break}}}else if(debug){alert('webkitSpeechRecognition property not found on this device')}
return!1}
