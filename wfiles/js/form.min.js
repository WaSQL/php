...
if(display==1){if(undefined!=els[i].dataset.display){els[i].style.display=els[i].dataset.display}else{els[i].style.display='initial'}
display_count=display_count+1}else{els[i].style.display='none'}}else{els[i].display='none'}}
