...
function formDictate(inp,ico,frm,continuous){console.log('formDictate');inp=getObject(inp);if(undefined==inp){console.log('formDictate error: undefined input '+inp);return!1}
...
if(undefined!=this.ico){this.ico.classList.remove('w_blink');this.ico.classList.remove('w_success')}}}}else{console.log('webkitSpeechRecognition not available')}
return!1}
