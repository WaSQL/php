...
let els=frm.querySelectorAll('[data-displayif]');if(debug==1){console.log(' - displayif els count:'+els.length)}
...
let ifel=frm.querySelectorAll('[name="'+name+'"], [name="'+name+'[]"]');if(debug==1){console.log(' - i:'+i+', name:'+name+', count:'+ifel.length)}
...
break}
if(display==1){break}}
if(debug==1){console.log(' - display:'+display+', name:'+name+', vals:'+vals)}
