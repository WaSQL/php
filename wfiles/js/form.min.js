...
tagdiv.appendChild(tagspan);if(params['-control']=='date'){initPikadayCalendar(tag.id,tagspan.id)}
if(undefined!=params['-parent']){var pobj=getObject(params['-parent']);if(undefined!=pobj){pobj.appendChild(tagdiv)}else{console.log(params['-parent']+' does not exist')}}
return tagdiv}
