...
if(display==1){if(undefined!=els[i].dataset.display){els[i].style.display=els[i].dataset.display;if(debug==1){console.log(' - set 1 style.display:'+els[i].dataset.display)}}else{els[i].style.display='initial';if(debug==1){console.log(' - set 2 style.display: initial')}}
