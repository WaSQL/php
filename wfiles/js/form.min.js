...
console.log(els[i].dataset.displayif+' = '+ifel.length);if(ifel.length>0){let display=0;for(let f=0;f<ifel.length;f++){let cval='';switch(ifel[f].type.toLowerCase()){case 'select-one':cval=ifel[f].options[ifel[f].selectedIndex].value;if(cval.toLowerCase()==1){display=1}
...
if(cval.toLowerCase()=='yes'){display=1}
break}}
if(display==1){els[i].display='block'}else{els[i].display='none'}}else{els[i].display='none'}}}
