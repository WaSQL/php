...
if(undefined!=theForm.show_upload_progress){formShowUploadProgress()}
let dlist=document.querySelectorAll('.w_disable_on_submit');for(let d=0;d<dlist.length;d++){dlist[d].setAttribute('disabled','disabled')}
let hlist=document.querySelectorAll('.w_hide_on_submit');for(let h=0;h<hlist.length;h++){hlist[h].style.display='none'}
return!0}
function formShowUploadProgress(){html='';html+='<div class="w_centerpop_title">Uploading...</div>'+"\n";html+='<div class="w_centerpop_content">'+"\n";html+='	<div class="w_padtop"><span class="icon-spin4 w_rotate w_spin"></span> Uploading ...</div>'+"\n";html+='</div>'+"\n";centerpopDiv(html,0)}
