...
function pagingExport(frm){let div=frm._export_formname.value+'_exportbutton';let pushparams=frm._export_params_.innerText;return ajaxGet('/php/index.php',div,{_pushexport:1,_pushparams:pushparams})}
