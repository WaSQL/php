...
let els=frm.querySelectorAll('[data-readonlyif]');if(debug==1){console.log(' - readonlyif el count:'+els.length)}
...
if(readonly==1){els[i].setAttribute('readonly','readonly')}else{els[i].removeAttribute('readonly')}}else{els[i].removeAttribute('readonly')}}
