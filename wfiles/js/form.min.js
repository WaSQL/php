...
if(undefined!=attrs['data-mindate']){if(attrs['data-mindate'].indexOf('-')!=-1){let n=parseInt(attrs['data-mindate'])*-1;if(undefined!=attrs['data-debug']){console.log('mindate n='+n)}
let d=new Date();d.setDate(d.getDate()-n);opts.minDate=d}else{switch(attrs['data-mindate'].toLowerCase()){case 'now':case 'today':opts.minDate=new Date();break;default:opts.minDate=new Date(attrs['data-mindate']);break}}}
