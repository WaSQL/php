...
theForm[i].focus();return!1}}else if(mask=='date'){if(isDate(theForm[i].value)==!1){var msg=dname+" must be a valid date ";if(undefined!=fldmsg){msg=fldmsg}
submitFormAlert(msg,popup,5);if(debug==1){console.log(msg)}
theForm[i].focus();return!1}}else if(mask=='futuredate'){if(isFutureDate(theForm[i].value)==!1){var msg=dname+" must be of valid date in the future ";if(undefined!=fldmsg){msg=fldmsg}
submitFormAlert(msg,popup,5);if(debug==1){console.log(msg)}
theForm[i].focus();return!1}}else if(mask=='pastdate'){if(isPastDate(theForm[i].value)==!1){var msg=dname+" must be of valid date in the past ";if(undefined!=fldmsg){msg=fldmsg}
submitFormAlert(msg,popup,5);if(debug==1){console.log(msg)}
theForm[i].focus();return!1}}else if(mask=='intlphone'){if(checkInternationalPhone(theForm[i].value)==!1){var msg=dname+" must be a valid phone number";if(undefined!=fldmsg){msg=fldmsg}
submitFormAlert(msg,popup,5);if(debug==1){console.log(msg)}
...
submitFormAlert(msg,popup,5);theForm[i].focus();if(debug==1){console.log(msg)}
return!1}}}
...
let sets=filters.split(";");console.log(sets);for(let s=0;s<sets.length;s++){let fltrs=sets[s].split(" ");let id='id'+fltrs[0]+fltrs[1];if(undefined!=fltrs[2]){id=id+fltrs[2].replace(/[\W_]+/g,"")}
