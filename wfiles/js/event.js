...
function eventRecorderAudioControl(el){
...
async function eventRecorderAudio(el){
					...
					reader.onloadend = function () {
						...
						if(undefined != fld){
							...
							if(undefined == reset && undefined != prev){
								...
								reset.setAttribute('onclick','eventRecorderAudioControl(this);');
						...
						if(undefined == play){
							...
							play.setAttribute('onclick','eventRecorderAudioControl(this);');
