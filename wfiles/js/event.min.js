...
formChanged(frm)}}}
function initCustomValidity(){els=document.querySelectorAll('textarea[data-required_msg],input[data-required_msg],select[data-required_msg]');for(let i=0;i<els.length;i++){els[i].oninvalid=function(e){e.target.setCustomValidity('');if(!e.target.validity.valid){e.target.setCustomValidity(e.dataset.required_msg)}};els[i].oninput=function(e){e.target.setCustomValidity('')}}}
