...
break;case 'defaulthour':k='defaultHour';break;case 'defaultminute':k='defaultMinute';break;case 'disablemobile':k='disableMobile';break;case 'enabletime':k='enableTime';break;case 'enableseconds':k='enableSeconds';break;case 'firstdayofweek':case 'firstday':k='firstDayOfWeek';break;case 'hourincrement':k='hourIncrement';break;case 'maxdate':k='maxDate';if(!isNaN(v)){if(v<0){v=Math.abs(v);v=new Date(new Date().setDate(new Date().getDate()-v)).toLocaleDateString('en-CA')}else if(v>0){v=Math.abs(v);v=new Date(new Date().setDate(new Date().getDate()+v)).toLocaleDateString('en-CA')}}else if(v.toLowerCase()=='today'){v=new Date().toLocaleDateString('en-CA')}
