...
if(in_array("email-link",behaviors)){var email=navEls[n].dataset.value||navEls[n].innerText;email=email.replace(/^[\/]+/,'',email);email=email.replace(/[\/]+$/,'',email);email=email.replace(/[\/]/,'@',email);email=email.replace(/[\/]/,'.',email);navEls[n].href='mailto:'+email;setText(navEls[n],email);navEls[n].setAttribute('data-behavior','processed')}
