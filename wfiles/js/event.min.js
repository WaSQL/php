...
if(in_array("fileupload",behaviors)){if(window.File&&window.FileReader&&window.FileList&&window.Blob){navEls[n].setAttribute('_bgcolor',navEls[n].style.backgroundColor||'');addEventHandler(navEls[n],"dragover",function(evt){cancelBubble(evt)},!1);addEventHandler(navEls[n],"dragenter",function(evt){cancelBubble(evt);this.style.backgroundColor=this.getAttribute('data-color-over')||'rgba(249,249,153,0.35)'},!1);addEventHandler(navEls[n],"drop",function(evt){evt=evt||window.event;cancelBubble(evt);this.style.backgroundColor=this.getAttribute('_bgcolor');fileUploadBehavior(evt,this)},!1)}else{setText(navEls[n],'Fileupload via dragdrop is not supported in your browser.')}}
