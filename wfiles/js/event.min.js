...
let w=getWidth(sObj);let h=getHeight(sObj);let vp=getViewportSize();var sw=getScrollWidth();var sh=getScrollHeight();var x=Math.round((vp.w/2)-(w/2))+sw;var y=Math.round((vp.h/2)-(h/2))+sh;sObj.style.position='absolute';sObj.style.left=x+'px';if(undefined==y){y=10}
if(y<10){y=10}
