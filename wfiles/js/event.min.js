...
let str=list[i].getAttribute('data-onload');list[i].setAttribute('data-onload-ex',new Date().getTime());try{let strfunc=new Function(str);strfunc()}catch(error){console.log('eventProcessBuildOnLoad Error');console.log(str);console.log(error)}}}
