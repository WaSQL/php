...
return!1}
function initFlatpickr(){let els=document.querySelectorAll('input[data-behavior="flatpickr"]');if(els.length){flatpickr.init.prototype.defaultConfig.prevArrow="<span class='icon-arrow-left'></span>";flatpickr.init.prototype.defaultConfig.nextArrow="<span class='icon-arrow-right'></span>"}
let nlang=navigator.language||'en-US';let lang=nlang.split('-')[0];switch(lang.toLowerCase()){case 'es':flatpickr.init.prototype.l10n.months.longhand=['enero','febrero','marzo','abril','mayo','junio','julio','agosto','septiembre','octubre','noviembre','diciembre'];flatpickr.init.prototype.l10n.months.shorthand=['enero','feb.','marzo','abr.','mayo','jun.','jul.','agosto','sept.','oct.','nov.','dic.'];flatpickr.init.prototype.l10n.weekdays.longhand=['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado'];flatpickr.init.prototype.l10n.weekdays.shorthand=['Dom','Lun','Mar','Mié','Jue','Vie','Sáb'];flatpickr.init.prototype.l10n.firstDayOfWeek=1;break;case 'de':flatpickr.init.prototype.l10n.months.longhand=['Januar','Februar','März','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember'];flatpickr.init.prototype.l10n.months.shorthand=['Jan.','Feb.','Marz','Apr.','Mai','Juni.','Juli','Aug.','Sept.','Okt.','Nov.','Dez.'];flatpickr.init.prototype.l10n.weekdays.longhand=['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag'];flatpickr.init.prototype.l10n.weekdays.shorthand=['Son','Mon','Die','Mit','Don','Fre','Sam'];flatpickr.init.prototype.l10n.firstDayOfWeek=1;break;case 'fr':flatpickr.init.prototype.l10n.months.longhand=['janvier','février','mars','avril','mai','juin','juillet','août','septembre','octobre','novembre','décembre'];flatpickr.init.prototype.l10n.months.shorthand=['janv.','févr.','mars','avril.','mai','juin','juil.','août','sept.','oct.','nov.','déc.'];flatpickr.init.prototype.l10n.weekdays.longhand=['Dimanche','Lundi','Mardi','Mercredi','Jeudi','Vendredi','Samedi'];flatpickr.init.prototype.l10n.weekdays.shorthand=['Dim','Lun','Mar','Mer','Jeu','Ven','Sam'];flatpickr.init.prototype.l10n.firstDayOfWeek=1;break;case 'it':flatpickr.init.prototype.l10n.months.longhand=['gennaio','febbraio','marzo','aprile','maggio','giugno','luglio','agosto','settembre','ottobre','novembre','dicembre'];flatpickr.init.prototype.l10n.months.shorthand=['genn.','febbr.','mar.','abr.','magg.','giugno','luglio','ag.','sett.','ott.','nov.','dic.'];flatpickr.init.prototype.l10n.weekdays.longhand=['Domenica','Lunedì','Martedì','Mercoledì','Giovedì','Venerdì','Sabato'];flatpickr.init.prototype.l10n.weekdays.shorthand=['Dom','Lun','Mar','Mer','Gio','Ven','Sab'];flatpickr.init.prototype.l10n.firstDayOfWeek=1;break}
flatpickr('input[data-behavior="flatpickr"]');return!1}
