...
list[i].setAttribute('data-onload-ex',new Date().getTime());let strs=list[i].getAttribute('data-onload').split(';');for(let s=0;s<strs.length;s++){let str=strs[s];try{let strfunc=new Function(str);strfunc()}catch(error){console.log('eventProcessBuildOnLoad Error #'+s);console.log(str);console.log(error)}}}}
