...
els[i].dataset.initflatpickr=1;let lang=els[i].dataset.lang||nlang;let config={};config.prevArrow="<span class='icon-arrow-left'></span>";config.nextArrow="<span class='icon-arrow-right'></span>";for(k in els[i].dataset){let v=els[i].dataset[k];switch(k.toLowerCase()){case 'altformat':k='altFormat';break;case 'altinput':k='altInput';break;case 'altinputclass':k='altInputClass';break;case 'allowinput':k='allowInput';break;case 'allowinvalidpreload':k='allowInvalidPreload';break;case 'appendto':k='appendTo';v=document.querySelector(v)||getObject(v);break;case 'ariadateformat':k='ariaDateFormat';break;case 'conjunction':k='conjunction';break;case 'clickopens':k='clickOpens';break;case 'dateformat':k='dateFormat';break;case 'defaultdate':k='defaultDate';break;case 'defaulthour':k='defaultHour';break;case 'defaultminute':k='defaultMinute';break;case 'disablemobile':k='disableMobile';break;case 'enabletime':k='enableTime';break;case 'enableseconds':k='enableSeconds';break;case 'hourincrement':k='hourIncrement';break;case 'maxdate':k='maxDate';break;case 'mindate':k='minDate';break;case 'minuteincrement':k='minuteIncrement';break;case 'nextarrow':k='nextArrow';break;case 'nocalendar':k='noCalendar';break;case 'prevarrow':k='prevArrow';break;case 'shorthandcurrentmonth':k='shorthandCurrentMonth';break;case 'showmonths':k='showMonths';break;case 'weeknumbers':k='weekNumbers';break;case 'monthselectortype':k='monthSelectorType';break;default:continue;break}
switch(v.toLowerCase()){case 'true':case '1':v=!0;break;case 'false':case '0':v=!1;break}
config[k]=v}
switch(lang.toLowerCase()){case 'es':config.locale={};config.locale.months={};config.locale.months.longhand=['enero','febrero','marzo','abril','mayo','junio','julio','agosto','septiembre','octubre','noviembre','diciembre'];config.locale.months.shorthand=['enero','feb.','marzo','abr.','mayo','jun.','jul.','agosto','sept.','oct.','nov.','dic.'];config.locale.weekdays={};config.locale.weekdays.longhand=['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado'];config.locale.weekdays.shorthand=['Dom','Lun','Mar','Mié','Jue','Vie','Sáb'];config.locale.firstDayOfWeek=1;break;case 'de':config.locale={};config.locale.months={};config.locale.months.longhand=['Januar','Februar','März','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember'];config.locale.months.shorthand=['Jan.','Feb.','Marz','Apr.','Mai','Juni.','Juli','Aug.','Sept.','Okt.','Nov.','Dez.'];config.locale.weekdays={};config.locale.weekdays.longhand=['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag'];config.locale.weekdays.shorthand=['Son','Mon','Die','Mit','Don','Fre','Sam'];config.locale.firstDayOfWeek=1;break;case 'fr':config.locale={};config.locale.months={};config.locale.months.longhand=['janvier','février','mars','avril','mai','juin','juillet','août','septembre','octobre','novembre','décembre'];config.locale.months.shorthand=['janv.','févr.','mars','avril.','mai','juin','juil.','août','sept.','oct.','nov.','déc.'];config.locale.weekdays={};config.locale.weekdays.longhand=['Dimanche','Lundi','Mardi','Mercredi','Jeudi','Vendredi','Samedi'];config.locale.weekdays.shorthand=['Dim','Lun','Mar','Mer','Jeu','Ven','Sam'];config.locale.firstDayOfWeek=1;break;case 'it':config.locale={};config.locale.months={};config.locale.months.longhand=['gennaio','febbraio','marzo','aprile','maggio','giugno','luglio','agosto','settembre','ottobre','novembre','dicembre'];config.locale.months.shorthand=['genn.','febbr.','mar.','abr.','magg.','giugno','luglio','ag.','sett.','ott.','nov.','dic.'];config.locale.weekdays={};config.locale.weekdays.longhand=['Domenica','Lunedì','Martedì','Mercoledì','Giovedì','Venerdì','Sabato'];config.locale.weekdays.shorthand=['Dom','Lun','Mar','Mer','Gio','Ven','Sab'];config.locale.firstDayOfWeek=1;break}
