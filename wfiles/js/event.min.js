...
if(repeat==0){el.innerHTML='00:00:00';countdownBeep()}else{el.innerText=h+':'+m+':'+s}}else if(timeArray.length==2){let t=new Date(c.getFullYear(),c.getMonth(),c.getDay(),c.getHours(),timeArray[0],timeArray[1]-1);let m=t.getMinutes();let s=t.getSeconds();if(m==0&&s==0){repeat=0}
if(m.toString().length==1){m='0'+m}
if(s.toString().length==1){s='0'+s}
if(repeat==0){el.innerHTML='00:00';countdownBeep()}else{el.innerText=m+':'+s}}
