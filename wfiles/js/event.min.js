...
tooltipDivObj=obj;let params={};params.position=obj.getAttribute('data-tooltip_position')||'';let txt=obj.getAttribute('data-tooltip')||'';if(txt.indexOf('id:')===0){let divid=str_replace('id:','',txt);txt=getText(divid)||''}else if(txt.indexOf('js:')===0){let f=str_replace('js:','',txt);let jsfunc=new Function(f);txt=jsfunc()}else if(txt.indexOf('ajax:')===0){params.ajax=str_replace('ajax:','',txt);txt=''}else if(txt.indexOf('att:')===0){let att=str_replace('att:','',txt);txt=obj.getAttribute(att)||''}
...
if(repeat==1){this.timer=window.setTimeout(countdownTime,1000,id)}}
