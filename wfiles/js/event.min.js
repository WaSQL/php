...
function countDownDate(divid,yr,m,d,hr,min,tz){let args=new Array(divid,yr,m,d,hr,min,tz);console.log('countDownDate');console.log(args);if(undefined==tz){tz=''}
