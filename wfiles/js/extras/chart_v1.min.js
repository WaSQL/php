...
if(this.animations.length>0){helpers.requestAnimFrame.call(window,this.digestWrapper)}}};helpers.addEvent(window,"resize",(function(){var timeout;return function(){clearTimeout(timeout);timeout=setTimeout(function(){each(Chart.instances,function(instance){if(instance.options.responsive){instance.resize(instance.render,!0)}})},50)}})());if(amd){define('Chart',[],function(){return Chart})}else if(typeof module==='object'&&module.exports){module.exports=Chart}
