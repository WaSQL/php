...
!(function (t, e) {
    ...
    class i extends EventTarget {
        ...
        _strokeBegin(t) {
            ...
            const e = { dotSize: this.dotSize, minWidth: this.minWidth, maxWidth: this.maxWidth, penColor: this.penColor, points: [] };
        ...
        _strokeUpdate(t) {
            ...
            if (!r || !r || !a) {
                ...
                r ? t && this._drawCurve(t, { penColor: d, dotSize: l, minWidth: c, maxWidth: u }) : this._drawDot(s, { penColor: d, dotSize: l, minWidth: c, maxWidth: u }), h.push({ time: s.time, x: s.x, y: s.y, pressure: s.pressure });
            }
        ...
        _fromData(e, i, n) {
            for (const s of e) {
                const { penColor: e, dotSize: o, minWidth: h, maxWidth: r, points: a } = s;
                if (a.length > 1)
                ...
                else this._reset(), n(a[0], { penColor: e, dotSize: o, minWidth: h, maxWidth: r });
            }
        }
        _toSVG() {
            const t = this._data,
