...
if(el.nodeName.toLowerCase()=='li'){wacss.addClass(el,'active')}else{let li=wacss.getParent(el,'li');let lip=wacss.getParent(li,'ul');if(!lip.classList.contains('nav-tabs')){li=wacss.getParent(lip,'li')}
