...
let winWidth=parseInt(w/systemZoom);let winHeight=parseInt(h/systemZoom);let win=window.open(nav,title,'width='+winWidth+',height='+winHeight+',left='+left+',top='+top+',menubar=no,toolbar=no,location=no,scrollbars=yes');return!1}
