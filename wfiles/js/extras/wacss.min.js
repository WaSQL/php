...
el.className='toast dismiss';setTimeout(function(){wacss.removeObj(el)},1000)},getObject:function(obj){if(typeof(obj)=='object'){return obj}else if(typeof(obj)=='string'){let qso=document.querySelector(obj);if(typeof(qso)=='object'){return qso}
