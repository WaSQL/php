...
params.txt=txt;if('speechSynthesis' in window){if(undefined==params.multiple){window.speechSynthesis.cancel()}
let voices=window.speechSynthesis.getVoices();if(undefined!=params.debug){console.log(voices)}
