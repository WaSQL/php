...
return!1},function(err){if(undefined!=navigator.geoSetFldFailed){if(wacss.function_exists(navigator.geoSetFldFailed)){window[navigator.geoSetFldFailed]({code:err.code,message:err.message})}else{let errfld=document.querySelector(navigator.geoSetFldFailed);if(undefined!=errfld){wacss.setText(err.message)}else{console.log('wacss.getGeoLocation error');console.log(err.message)}}}else{console.log('wacss.getGeoLocation error');console.log(err.message)}
return!1},options)}
