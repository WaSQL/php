...
if(undefined!=list[i].dataset.beginatzero&&(list[i].dataset.beginatzero==1||list[i].dataset.beginatzero=='true')){if(undefined==lconfig.options.scales){lconfig.options.scales={yAxes:[{ticks:{beginAtZero:!0}}]}}
...
if(undefined!=list[i].getAttribute('data-beginatzero')&&list[i].getAttribute('data-beginatzero')==1){if(undefined==lconfig.options.scales){lconfig.options.scales.yAxes[0].ticks.beginAtZero=!0}
