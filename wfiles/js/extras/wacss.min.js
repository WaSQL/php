...
return!1},options)}
return!1},geoLocationMap:function(lat,long,params){console.log('geoLocationMap');lat=parseFloat(lat);long=parseFloat(long);console.log(lat);console.log(long);console.log(params);if(undefined==params){params={}}
