...
return!1},init:function(){wacss.initWacssEdit();wacss.initChartJs();wacss.initTruncate()},initChartJs:function(){let list=document.querySelectorAll('div.chartjs');for(let i=0;i<list.length;i++){if(undefined==list[i].id){console.log('missing id',list[i]);continue}
