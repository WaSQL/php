...
let defaults={mode:'text/html',indentWithTabs:!0,smartIndent:!0,lineNumbers:!0,lineWrapping:!1,matchBrackets:!0,autofocus:!0,extraKeys:{"Ctrl-Space":"autocomplete"}};if(undefined==this.codemirror){this.codemirror={}}
...
params[k]=v}
switch(params.mode.toLowerCase()){case 'sql':params.mode='text/x-sql';break;case 'css':params.mode='text/css';break;case 'javascript':params.mode='text/javascript';break;case 'php':params.mode='application/x-httpd-php';break;case 'python':params.mode={name:'python',version:3,singleLineStringErrors:!1};break;case 'html':let mixedMode={name:"htmlmixed",scriptTypes:[{matches:/\/x-handlebars-template|\/x-mustache/i,mode:null},{matches:/(text|application)\/(x-)?vb(a|script)/i,mode:"vbscript"}]};params.mode=mixedMode;break;case 'lua':params.mode='text/x-lua';break;case 'vbscript':params.mode='text/vbscript';break;case 'xml':params.mode='application/xml';break}
