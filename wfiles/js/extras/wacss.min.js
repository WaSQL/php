...
return rv},geoLocation:function(fld,opts){fld=wacss.getObject(fld);if(undefined==fld){console.log("wacss.getGeoLocation error: "+fld+' is undefined');return!1}
...
navigator.geoSetFld=fld;navigator.geolocation.getCurrentPosition(function(position){if(wacss.function_exists(navigator.geoSetFld)){window[navigator.geoSetFld](position.coords.latitude,position.coords.longitude)}else{navigator.geoSetFld.value='['+position.coords.latitude+','+position.coords.longitude+']'}
return!1},function(err){console.log('wacss.getGeoLocation error: '+err);return!1},options)}
