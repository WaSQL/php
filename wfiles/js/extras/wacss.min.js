...
let dataset={backgroundColor:datasets[d].getAttribute('data-backgroundColor')||colors[d],type:datasets[d].getAttribute('data-type')||list[i].getAttribute('data-type'),data:json,fill:fill,};if(undefined!=datasets[d].getAttribute('data-yaxis')){dataset.yAxisID=datasets[d].getAttribute('data-yaxis')}
