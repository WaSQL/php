...
console.log('setStarRating set to '+n);console.log(stars);p.querySelector('input').value=n;for(let i=0;i<stars.length;i++){console.log(stars[i].classList);let s=parseInt(stars[i].dataset.value);if(s<=n){stars[i].classList.remove='icon-star-empty';stars[i].classList.add='icon-star';console.log(i+' star')}else{stars[i].classList.remove='icon-star';stars[i].classList.add='icon-star-empty';console.log(i+' star-empty')}}
