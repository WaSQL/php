...
let i=document.createElement('img');i.src=el.getAttribute('src');i.style.maxWidth='100%';i.style.maxHeight='770px';i.d=d;i.onload=function(){centerObject(this.d)}
...
z=z||10020;let d=document.createElement('div');d.id="modal1";d.tabindex=0;d.style.zIndex=z;d.style.display='block';d.style.background='#FFF';d.style.padding='15px';d.style.border='1px outset #747392';d.style.borderRadius='3px';d.style.position='absolute';d.style.textAlign='center';d.style.maxWidth='60%';d.style.maxHeight='800px';d.style.transform='scaleX(1) scaleY(1)';if(undefined!=title&&title.length){let t=document.createElement('div');t.className='w_big w_bold align-center';t.innerHTML=title;d.appendChild(t)}
let vid=document.createElement('video');vid.src=el.getAttribute('src');vid.setAttribute('controls','');vid.setAttribute('autoplay','');vid.setAttribute('playsinline','');vid.style.maxWidth='100%';vid.style.maxHeight='770px';vid.style.width='auto';vid.style.height='auto';vid.d=d;vid.oncanplay=function(){centerObject(this.d)}
d.appendChild(vid)
