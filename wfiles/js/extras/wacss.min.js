...
params.zoom=params.zoom||13;let myLatlng={lat:params.lat,lng:params.long};let map=new google.maps.Map(params.div,{center:myLatlng,mapTypeId:'roadmap',zoom:params.zoom,styles:[{featureType:'poi',elementType:'labels',stylers:[{visibility:'off'}]}]});if(undefined!=params.markers){if(!Array.isArray(params.markers)){params.markers=new Array(params.markers)}
