...
xmlhttp.send(data);return!1},ajaxProcessResponse:function(obj){let div=wacss.getObject(obj.div);let txt=obj.ajaxtext||obj.responseText;if(undefined==div){console.log('dom object does not exist');console.log(txt)}else{if(undefined!=obj.processing){obj.processing.innerHTML=obj.processing.previous}
