...
label+=parseFloat(tooltipItem.value).toFixed(2);return label}}}};if(undefined!=list[i].getAttribute('data-ysteps')){if(undefined==lconfig.options.scales.yAxes.ticks){lconfig.options.scales.yAxes.ticks={}}
lconfig.options.scales.yAxes.ticks.steps=list[i].getAttribute('data-ysteps');lconfig.options.scales.yAxes.ticks.steps.beginAtZero=!0}
...
lconfig.options.scales.yAxes.ticks.stepValue=list[i].getAttribute('data-ystepvalue')}
...
lconfig.options.scales.yAxes.ticks.max=list[i].getAttribute('data-ymax')}
