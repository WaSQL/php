...
let v=list[i].dataset[k];if(k.startsWith('ctrl_')){k=k.toUpperCase().replace('_','-');curr_defaults.extraKeys[k]=v;continue}else if(k.startsWith('shift_')){k=k.toUpperCase().replace('_','-');curr_defaults.extraKeys[k]=v;continue}else if(k.startsWith('f_')&&k.length<4){k=k.toUpperCase().replace('_','');curr_defaults.extraKeys[k]=v;continue}
