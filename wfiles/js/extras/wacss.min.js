...
if(undefined!=list[i].getAttribute('data-stacked')){if(undefined!=wacss.chartjs[list[i].id].config.options.scales.yAxes[0]){wacss.chartjs[list[i].id].config.options.scales.yAxes[0].stacked=!0}
...
if(foundchart==0){let lconfig={type:list[i].getAttribute('data-type'),data:{labels:labels,datasets:[]},options:options};if(undefined!=list[i].getAttribute('data-stacked')){if(undefined!=undefined!=lconfig.options.scales.yAxes[0]){lconfig.options.scales.yAxes[0].stacked=!0}
