...
if(elobj.dataset[k].indexOf('id:')==0){let cid=elobj.dataset[k].replace('id:','');let cidobj=document.querySelector('#'+cid);if(undefined!=cidobj){params[k]=cidobj.innerText}else{params[k]=elobj.dataset[k]}}else{params[k]=elobj.dataset[k]}}
...
return!1},scrollIntoView(el,p){el=wacss.getObject(el);if(undefined==el){return!1}
