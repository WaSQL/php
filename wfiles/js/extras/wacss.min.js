...
console.log('list: '+i);console.log(list[i]);if(undefined!=list[i].getAttribute('data-beginatzero')&&list[i].getAttribute('data-beginatzero')==1){if(undefined!=lconfig.options.scales){lconfig.options.scales.yAxes[0].ticks.beginAtZero=!0}
...
console.log('beginAtZero');console.log(lconfig.options.scales.yAxes[0])}
