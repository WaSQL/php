...
modal.setAttribute('data-position','unset');wacss.centerObject(modal);return modal},nav:function(el,opts){let elobj=wacss.getObject(el);if(undefined==elobj){return!1}
