...
ico.class_orig=ico.className;inp.color_orig=inp.style.borderColor;inp.style.borderColor='red';ico.className='icon-spin5 w_spin';if(navigator.geolocation){this.geoId=navigator.geolocation.watchPosition(function(position){if(undefined==this.counter){this.counter=0}
this.counter=this.counter+1;console.log('Try: '+this.counter);let latitude=position.coords.latitude;let longitude=position.coords.longitude;let accuracy=position.coords.accuracy;inp.value='['+position.coords.latitude+','+position.coords.longitude+','+position.coords.accuracy+','+this.counter+']';ico.title='try: '+this.counter+', Accuracy: '+position.coords.accuracy;if(parseInt(position.coords.accuracy)<=10||this.counter>5){ico.className=ico.class_orig;inp.style.borderColor=inp.color_orig;window.navigator.geolocation.clearWatch(geoId);console.log('latlon set');console.log(position.coords);return!1}},function error(msg){ico.className=ico.class_orig;inp.style.borderColor=inp.color_orig;window.navigator.geolocation.clearWatch(geoId);ico.title=ico.title+' - ERROR: '+msg;console.log('latlon error');return!1},{maximumAge:500,timeout:10000,enableHighAccuracy:!0})}else{ico.className=ico.class_orig;inp.style.borderColor=inp.color_orig;ico.title=ico.title+' - ERROR: '+"Geolocation API is not supported in your browser. Unable to set LatLon";console.log('latlon no support')}
