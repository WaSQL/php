...
return!1},function(err){if(undefined!=navigator.geoSetFldFailed){if(wacss.function_exists(navigator.geoSetFldFailed)){window[navigator.geoSetFldFailed]()}}else{console.log('wacss.getGeoLocation error: '+err)}
return!1},options)}
