...
el.classList.add='dismiss';setTimeout(function(){wacss.removeObj(el)},1000)},emulateEvent:function(el,ev){el=wacss.getObject(el);if(undefined==el){return!1}
