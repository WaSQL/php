...
let foundchart=0;console.log('initChartJs type: '+type);console.log(list[i]);switch(type){case 'guage':if(undefined!=wacss.chartjs[list[i].id]){let ck=list[i].querySelector('canvas');if(undefined!=ck){let gv=list[i].dataset.value||datadiv.innerText;gv=parseInt(gv);let max=list[i].dataset.max||180;let gv1=parseInt(max*(gv/100));if(gv1>max){gv1=max}
...
console.log('beginAtZero - 1');console.log(lconfig.options.scales.yAxes[0])}
...
if(undefined!=lconfig.options.scales.yAxes[0].ticks){lconfig.options.scales.yAxes[0].ticks.beginAtZero=!0}
if(undefined!=lconfig.options.scales.yAxes[0].ticks.beginAtZero){lconfig.options.scales.yAxes[0].ticks.beginAtZero=!0}
console.log('beginAtZero - 2');console.log(lconfig.options.scales.yAxes[0])}
