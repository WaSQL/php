...
dropzones[d].ondragenter=function(ev){if(undefined!=this.dataset.dropmsg){if(undefined!=this.dataset.tip){this.dataset.tip_ori=this.dataset.tip}
this.dataset.tip=this.dataset.dropmsg}}
dropzones[d].ondragleave=function(ev){if(undefined!=this.dataset.tip_ori){this.dataset.tip_ori=this.dataset.tip_ori}}
...
if(undefined==tel.dataset.ondrop){console.log('wacss.initDrag ondrop error: no ondrop in tel');return!1}
