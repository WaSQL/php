...
z=z||10020;let d=document.createElement('div');d.id="modal1";d.tabindex=0;d.style.zIndex=z;d.style.display='block';d.style.background='#FFF';d.style.padding='15px';d.style.border='1px outset #747392';d.style.borderRadius='3px';d.style.position='absolute';d.style.maxWidth='60%';d.style.maxHeight='800px';d.style.transform='scaleX(1) scaleY(1)';let vid=document.createElement('video');vid.src=el.getAttribute('src');vid.setAttribute('controls','');vid.setAttribute('autoplay','');vid.setAttribute('playsinline','');vid.style.maxWidth='80%';vid.style.maxHeight='80%';vid.style.width='auto';vid.style.height='auto';vid.d=d;vid.onload=function(){centerObject(this.d)}
d.appendChild(vid)
