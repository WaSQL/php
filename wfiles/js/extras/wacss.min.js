...
params[k]=implode(',',cidvals)}else{params[k]=elobj.dataset[k]}}
...
let winWidth=parseInt(w/systemZoom);let winHeight=parseInt(h/systemZoom);let pairs=new Array();for(k in params){if(k=='passthru'){continue};pairs.push(k+'='+params[k])}
