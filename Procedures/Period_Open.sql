...
begin
	...
	select period_id.nextval, p.period_type_id, p.beg_date, p.end_date, t.recurring_date_code, t.recurring_date_value
	into ln_Period_id, ln_Period_type_id, ln_Beg_Date, ln_End_Date, ln_Recur_Date_Code, ln_Recur_Date_Value
	...
	insert into Period
	(period_id, period_type_id, beg_date, end_date)
	values
	(:ln_Period_id, :ln_Period_type_id, :ln_Beg_Date, :ln_End_Date);
