drop Procedure Commissions.Payout_Pres_Diamond_Set;
create Procedure Commissions.Payout_Pres_Diamond_Set(
					 pn_Period_id		int
...
Begin
	...
	Update period_batch
	Set beg_date_payout_9 = current_timestamp
      ,end_date_payout_9 = Null
	...
	-- Set Payout Detail
	replace payout_09 (period_id, batch_id, customer_id, rank_id, shares, shares_extra, from_currency, to_currency, exchange_rate, bonus, bonus_exchanged)
	select 
		  a.period_id
		, a.batch_id
		, a.customer_id
	...
	commit;
   	...
   	replace customer_history (customer_id, period_id, batch_id, payout_9)
   	select 
    	 customer_id
    	,period_id
   		,batch_id
	...
	group by customer_id,period_id,batch_id;
   	...
   	Update period_batch
   	Set end_date_payout_9 = current_timestamp
   	Where period_id = :pn_Period_id
   	and batch_id = :pn_Period_Batch_id;
