drop Procedure Commissions.Payout_Taiwan_Set;
create Procedure Commissions.Payout_Taiwan_Set(
					 pn_Period_id		int
...
Begin
	...
	Update period_batch
	Set beg_date_payout_10 = current_timestamp
      ,end_date_payout_10 = Null
	...
	-- Set Payout Detail
	replace payout_10 (period_id, batch_id, customer_id, rank_id, shares, shares_extra, from_currency, to_currency, exchange_rate, bonus, bonus_exchanged)
	select 
		  a.period_id
		, a.batch_id
		, a.customer_id
	...
	group by customer_id,period_id,batch_id;
   	...
   	Update period_batch
   	Set end_date_payout_10 = current_timestamp
   	Where period_id = :pn_Period_id
   	and batch_id = :pn_Period_Batch_id;
