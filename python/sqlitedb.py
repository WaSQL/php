...
# NOTE: addRecords function removed - contained PHP code by mistake
# If you need bulk insert functionality, it should be implemented in Python

#---------- begin function connect ----------
# @describe returns a database connection
# @param params tuple - parameters to override
# @return
#	cur_sqlite, conn_sqlite array
# @usage
#	cur_sqlite, conn_sqlite =  sqlitedb.connect(params)
def connect(params):
	dbconfig = {}
	#check config.CONFIG
