...
<h3>1. OVERVIEW</h3>
<div class="well w_small">
We value your engagement with our company, and we understand that you, in turn, value your privacy. This privacy policy (this "Privacy Policy") describes how Skillsai, LLC ("we," "us" or "Skillsai") maintains, uses and shares personal information that we may collect when you use our website at www.skillsai.com (the "Site") and any of the skills, products or services (the "Products") made available from the Site, the Amazon Alexa&trade; mobile app, our WordPress&trade; plugins or various app stores such as Google Play&trade; or the Apple App Store&reg; from time to time. We refer to the Site and the Products collectively in this Privacy Policy as the "Services." By using any of the Services, you acknowledge that you have read, understood, and consent to the provisions of this Privacy Policy.
<p>
...
<p>
This Policy does not cover any other data collection or processing, including without limitation the data we host or generate for our registered customers via the Skillsai software products.  If you use our products, the data that you (and your customers) submit or make available as you use our product will be governed by the applicable Skillsai agreement, and as required by law.
<p>
Please note that all product names, logos, and brands are property of their respective owners. All company, product and service names used are for identification purposes only. Use of these names, logos, and brands does not imply endorsement.
</div>

<h3>2. HOW WE COLLECT AND USE INFORMATION</h3>
<div class="well w_small">
Some of the information we collect when you use the Services, such as your name, postal address, email address, credit card information or telephone number, may allow you to be identified ("Personal Information"). In all of the following circumstances, we will use Personal Information for the purpose described below, as well as to supplement our database of marketing contacts, which we will use to provide and promote products and services from us or our marketing affiliates. We will not use this information for anything else not described in this Policy.
<p>
Registration: When you register on the Services, such as to subscribe to our Blog, request information or access a Product, you will be asked to provide certain Personal Information, which we will use to fulfill your request.
<p>
Data Integrity and Security: We use reasonable and diligent efforts to maintain accurate information on our customers, and have adopted and implemented reasonable industry standard security procedures to protect any such information collected. We constantly monitor our systems, which are protected using industry-standard security measures. Although Skillsai will use reasonable efforts to secure network communications and Services, we cannot guarantee that the information submitted to, maintained on, or transmitted from our systems will be completely secure.
<p>
Refer a Friend: If you choose to use our referral service to tell a friend about our Services, we will ask you for your friend's name and email address. We will use the information you provide to automatically send your friend an email inviting him or her to visit our Sites. Your friend can opt out of receiving future promotional/marketing messages from us by submitting the opt-out request form located at www.skillsai.com/opt-out or by clicking the "Unsubscribe" link found in the footer of our email messages. Your friend may also contact us using the information in the "How to Contact Us" section of this Policy, and request that we remove their information from our database. Treatment of your friend's information will be subject to the terms of this Privacy Policy.
<p>
...
<p>
Linking from Emails: If you link to our Site from an email message from us, we will be able to identify your email address and associate that email address with the manner in which you use the Site (e.g., which pages you visit or whether you make a purchase).
<p>
...
<ul>
<li>	The Internet domain from which you access the Services.
<li>	Your IP address.
<li>	The type of browser and operating system that you use.
<li>	The date and time you visited the Services.
<li>	The pages that you visited on the Services.
<li>	The address of the website you linked from to get to the Services.
</ul>
...
<p>
Communicating with You: We may use information that we collect from you for the purpose of communicating with you and responding to your inquiries. Those communications could, for example, take the form of service updates, promotions for products or services that we or one of our marketing partners provide. 
<p>
...
<h3>3. COLLECTION OF INFORMATION BY THIRD PARTIES</h3>
<div class="well w_small">
...
<div class="well w_small">
If you would like us to stop sending you email or other communications or would like to access your Personal Information to correct or delete it, you may send us a request at our email or postal address indicated below. We will endeavor to satisfy such requests within a reasonable time.
</div>
...
<h3>9. ACCOUNTABILITY</h3>
<div class="well w_small">
We are committed to adhering to our Privacy Policy and applicable laws and to making your online experience secure and valuable. If you have a question, request, complaint, dispute or concern related to this Privacy Policy, you may send a message by email to Support@Skillsai.com or in writing to Skillsai, LLC, Attn: Customer Support, 2110 Commotion Dr., Sandy, UT 84093. We will work with you to obtain a prompt resolution of any issues you may have.
</div>
<p>
&copy;2016 Skillsai, LLC Skillsai and Talk to the Cloud&trade; is a Trademark of Skillsai, LLC
